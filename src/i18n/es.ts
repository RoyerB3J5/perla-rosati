  ...
  aboutUs: {
    ...
    squad: {
      ...
      items: [
        {
          title: "Perla Rosati",
          description: "Maquillaje Profesional y Educadora",
          schedules: {
            title: "AGENDA TU CITA",
            items: ["Lunes a sábado", "8:00 am - 6:00 pm"],
          },
          ready: "¿Lista para tu próximo look?",
          schedule:
            "Agenda tu cita con Perla y encuentra el horario que mejor se adapte a ti.",
          button: {
        ...
        },
        {
          ...
          schedules: {
            title: "AGENDA TU CITA",
            items: ["Sábado", "8:00 am - 6:00 pm"],
          },
          ready: "¿Lista para tu próximo look?",
          schedule:
            "Agenda tu cita con Luisa y encuentra el horario que mejor se adapte a ti.",
          button: {
            label: "agendar mi cita",
            href: "#",
          },
        ...
        },
        {
          ...
          ready: "¿Lista para tu próximo look?",
          schedule:
            "Agenda tu cita con María y encuentra el horario que mejor se adapte a ti.",
          button: {
            label: "agendar mi cita",
            href: "#",
          },
        ...
        },
        {
          ...
          schedules: {
            title: "AGENDA TU CITA",
            items: ["Jueves a sábado", "8:00 am - 5:00 pm"],
          },
          ready: "¿Lista para tu próximo look?",
          schedule:
            "Agenda tu cita con Deisy y encuentra el horario que mejor se adapte a ti.",
          button: {
            label: "agendar mi cita",
            href: "#",
          },
        ...
        },
        {
          ...
          schedules: {
            title: "AGENDA TU CITA",
            items: ["Martes a sábado", "8:00 am - 5:00 pm"],
          },
          ready: "¿Lista para tu próximo look?",
          schedule:
            "Agenda tu cita con Elizabeth y encuentra el horario que mejor se adapte a ti.",
          button: {
            label: "agendar mi cita",
            href: "#",
          },
        ...
        },
        {
          title: "Valeria Kebbe",
          description:
            "Tratamientos faciales / Cejas y pestañas / Depilación laser ",
          schedules: {
            title: "AGENDA TU CITA",
            items: ["Martes a sábado", "8:00 am - 6:00 pm"],
          },
          ready: "¿Lista para tu próximo look?",
          schedule:
            "Agenda tu cita con Valeria y encuentra el horario que mejor se adapte a ti.",
          button: {
            label: "agendar mi cita",
            href: "#",
          },
  ...
  education: {
    ...
    items: [
      ...
      },
      {
        ...
        title: "Beauty Pro Master Academy — Con licencia de Florida",
        description:
          "Programa profesional que combina maquillaje, fundamentos de skincare y tratamientos faciales, preparando al estudiante para atender clientes, desarrollar habilidades técnicas, construir su negocio y ampliar oportunidades profesionales.",
        lists: [
          "Formación profesional en maquillaje.",
          " Fundamentos de skincare y tratamientos faciales.",
          "Diagnóstico y preparación básica de la piel.",
          "Gestión, precios, clientes y negocio.",
          " Marketing, marca personal y crecimiento profesional.",
        ],
        duration: "Duración: 7 semanas",
        href: "#",
      },
      {
        ...
        description:
          "Experiencia intensiva para maquilladores que desean perfeccionar técnicas en un solo día, combinando demostración, práctica supervisada, preparación de piel, maquillaje profesional, fotografía y recomendaciones personalizadas.",
        lists: [
          "Jornada intensiva y personalizada.",
          "El estudiante elige 2 técnicas profesionales.",
          "Práctica sobre modelo con supervisión.",
          "Incluye manual digital y certificado.",
          "Fotografía profesional para el portafolio.",
        ],
        duration: "Duración: aproximadamente 6 a 8 horas.",
        href: "#",
      },
      {
        image: "/images/education/5.webp",
        title: "Clase Especial de Automaquillaje en Pareja",
        description:
          "Experiencia compartida para aprender automaquillaje, desde skincare y preparación de piel hasta ojos, pestañas y acabados, adaptando un look cotidiano para ocasiones especiales mediante recomendaciones personalizadas.",
        lists: [
          "Experiencia diseñada para dos o más personas.",
          "Preparación y cuidado de la piel.",
          "Base, corrector, contorno, rubor e iluminador.",
          "Maquillaje de ojos adaptable para día y noche.",
          "  Guía digital, certificado y recomendaciones personalizadas.",
        ],
  ...
  contact: {
    hero: {
      ...
      items: [
        ...
        {
          label: "Email:",
          value: "perlarosatimakeup@gmail.com",
  ...
  footer: {
    ...
    contact: {
      ...
      items: [
        ...
        {
          label: "perlarosatimakeup@gmail.com",
          href: "https://mail.google.com/mail/?view=cm&fs=1&to=perlarosatimakeup@gmail.com",
        },
        {
          label: "13550 Village Park Drive, Orlando, Florida 32837",
          mailto: "#",
        },
      ],
    },
